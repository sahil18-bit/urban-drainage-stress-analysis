...
<div style="background:linear-gradient(135deg,rgba(13,33,55,0.9),rgba(10,61,98,0.7));
    ...
    <a href="{map_url}" target="_blank" style="background:linear-gradient(135deg,#1d4ed8,#1e40af);
        color:#ffffff;text-decoration:none;padding:0.9rem 2.5rem;border-radius:12px;
        font-weight:700;font-size:1rem;border:1px solid rgba(41,121,255,0.5);
        box-shadow:0 4px 20px rgba(29,78,216,0.4);display:inline-block;">
        🚀 Open Map Viewer ↗
    </a>
</div>
""", unsafe_allow_html=True)
...
steps = [
    ...
    ("4️⃣", "Upload and Filter", "Upload the CSV there and use month/status filters"),
]
...
<div class="glass-card">
    ...
    <div style="display:flex;gap:2rem;flex-wrap:wrap;">
        <div style="display:flex;align-items:center;gap:0.5rem;">
            ...
            <span style="color:#94a3b8;font-size:0.85rem;">SAFE — Utilization below 60%</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.5rem;">
            <div style="width:14px;height:14px;border-radius:50%;background:#fb923c;"></div>
            <span style="color:#94a3b8;font-size:0.85rem;">STRESSED — Utilization 60 to 90%</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.5rem;">
            <div style="width:14px;height:14px;border-radius:50%;background:#f87171;"></div>
            <span style="color:#94a3b8;font-size:0.85rem;">CRITICAL — Utilization above 90%</span>
        </div>
        <div style="display:flex;align-items:center;gap:0.5rem;">
...
<div class="glass-card">
    ...
    <div style="color:#64748b;font-size:0.83rem;margin-bottom:1rem;">For offline mapping in QGIS, these files are available from the analysis pipeline:</div>
    <div style="display:grid;grid-template-columns:repeat(2,1fr);gap:0.8rem;">
        <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:8px;padding:0.8rem;">
            ...
            <div style="color:#475569;font-size:0.75rem;margin-top:0.2rem;">300 drain points with status and failure probability</div>
        </div>
        <div style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.07);border-radius:8px;padding:0.8rem;">
